...
import { ProductInStockContainer } from '../../../core/components/productInStock/ProductInStockContainer';
  ...
  return (
    <ProductItemContainer>
      ...
      <ProductDescriptionContainer>
        ...
        <ProductInStockContainer countProductInStock={product.quantityInStock} />
        ...
        <ProductFooter>
          ...
          <ButtonsContainers>
            <Button style={{ textTransform: 'none' }} disabled={!product.quantityInStock}>
              Add to cart
            </Button>
            {productInFavorite ? (
